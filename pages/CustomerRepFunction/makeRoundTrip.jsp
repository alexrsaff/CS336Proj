...
<body>
	...
	<br>
	<form method="post" action="finishRoundTripUserCheckout.jsp">
		...
		<table>
            ...
            <tr>
                <td>INFORMATION FOR FIRST FLIGHT</td>
            </tr>
			<tr>
            ...
            <tr>
                <td>INFORMATION FOR SECOND FLIGHT</td>
            </tr>
            <tr>
                <td>Enter flight number: </td>
                <td><input type="number" name="flightNumTwo"></td>
            </tr>
            <tr>
                <td>Enter airline company: </td>
                <td><input type="text" name="airlineTwo" pattern="[A-Z]{2}"></td>
            </tr>
            <tr>
                <td>Class: </td>
                <td>
                    <select name="classBookedTwo" size=1>
                        <option value="economy">Economy Class</option>
                        <option value="business">Business Class</option>
                        <option value="first">First Class</option>
                    </select>				
