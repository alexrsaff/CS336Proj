...
<html>
    <head>
        <title>Flights from Airport: <%out.print(request.getParameter("AirportSelection"));%></title>
    </head>
    <body>
			<%
    try
    {
		...
		String chosen = request.getParameter("AirportSelection");
		...
		String where = "WHERE D.airportID = '" + chosen + "' OR A.airportID = '" + chosen + "' ";
		String endChunk = " ORDER BY F.departDate, F.departTime ASC";
		String query = select + joins + where + endChunk;
        ...
        %>
					...
					<input type="button" onclick="window.location.href='allFlightsForAirport.jsp'" value="Back to airport selection"><br><br>
