...
<html>
    ...
    <body>
		...
		try {
            ...
            if(cnt.equals("1")) {
                out.println("The username wanted already exists, <a href='addCustomer.jsp'>please try again.</a>");
            }
            else {
                ...
                if (outcome == 0) {
                    ...
                    String update2 = "INSERT INTO Customer(username) SELECT username FROM Person WHERE username = '"+ username +"'";
